                        ...
                        <tbody>
                            @forelse ($reviewHR  as $items)
                                <tr>
                                    ...
                                    <td>
                                        @if($items->pdf_file)
                                            <a href="{{ Storage::url('public/pdf/Medical Leave/' . $items->user->nik . '-' . $items->user->name . '/' . $items->pdf_file) }}" target="_blank" class="btn btn-danger"><i class="fa-regular fa-file-pdf"></i></a>
                                        @else
                                            No PDF
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if ($items->review_date == null)
                                            <a href="{{ route('review.cutisakit', $items->id)}}" class="btn btn-primary">Review</a>
                                        @else
                                            <a href="{{ route('review.cutisakit', $items->id)}}" class="btn btn-success">Details</a>
                                        @endif
                                    </td>
                                </tr>
                            @empty
