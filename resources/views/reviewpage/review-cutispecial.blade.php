        ...
        <div class="card-body">
            <div class="desktop-2">
                <div class="a-4-1">
                    ...
                    @if ($special->user->employee_id >= 200000)
                    ...
                    <div class="identitas-kiri">
                        ...
                        <div class="div">:</div>
                        <div class="_600024">{{ $special->user->employee_id }}</div>
                        <div class="name">Name</div>
                        <div class="div2">:</div>
                        <div class="muhamad-arif-solikin">{{ $special->user->name }}</div>
                        <div class="department">Department</div>
                        <div class="div3">:</div>
                        <div class="production">{{ $special->department }}</div>
                        <div class="position">Position</div>
                        <div class="div4">:</div>
                        <div class="mechanical-oh-and-production-machine-supervisor">{{ $special->position_name }}</div>
                        <div class="position-code">Position Code</div>
                        <div class="div6">:</div>
                        <div class="pro-02">{{ $special->position_code }}</div>
                        <div class="direct-superior">Direct Superior</div>
                        <div class="div5">:</div>
                        <div class="production-manager">{{ $special->superior_name }}</div>
                        <div class="position-code2">Position Code</div>
                        <div class="div7">:</div>
                        <div class="pro-01">{{ $special->superior_code }}</div>
                    </div>
                    <div class="identitas-kanan">
                        <div class="from-date">From Date</div>
                        <div class="div8">:</div>
                        <div class="_21-jan-2024">{{ \Carbon\Carbon::parse($special->from_date)->format('d M Y') }}</div>
                        <div class="number-of-leave-days">Number of Leave Days</div>
                        <div class="div9">:</div>
                        <div class="_4">{{ $special->jumlah_hari }}</div>
                        <div class="to-date">To Date</div>
                        <div class="div10">:</div>
                        <div class="_24-jan-2024">{{ \Carbon\Carbon::parse($special->to_date)->format('d M Y') }}</div>
                        <div class="back-office-date">Back Office Date</div>
                        <div class="div11">:</div>
                        <div class="_25-jan-2024">{{ \Carbon\Carbon::parse($special->backoffice_date)->format('d M Y') }}
                        </div>
                    </div>
                    <div class="ketleave">
                        ...
                        <div class="_1">
                            ...
                            @if ($special->cuti == 'Cuti Melahirkan')
                                <img class="ceklis"
                        ...
                        <div class="_22">
                            ...
                            @if ($special->cuti == 'Cuti Keguguran')
                                <img class="ceklis2"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_3">
                            ...
                            @if ($special->cuti == 'Anggota Keluarga Pekerja dirawat di Rumah Sakit')
                                <img class="ceklis3"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_42">
                            ...
                            @if ($special->cuti == 'Pernikahan Karyawan')
                                <img class="ceklis4"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_5">
                            ...
                            @if ($special->cuti == 'Pernikahan anak karyawan')
                                <img class="ceklis5"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_6">
                            ...
                            @if ($special->cuti == 'Istri Karyawan Melahirkan, Keguguran')
                                <img class="ceklis6"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_7">
                            ...
                            @if ($special->cuti == 'Mengkhitankan atau Membaptiskan Anak')
                                <img class="ceklis7"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_8">
                            ...
                            @if ($special->cuti == 'Kematian (Istri,Suami,Anak,Menantu,Orang Tua,Mertua,Saudara Kandung)')
                                <img class="ceklis8"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_9">
                            ...
                            @if ($special->cuti == 'Kematian anggota keluarga dalam satu rumah')
                                <img class="ceklis9"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                        ...
                        <div class="_10">
                            ...
                            @if ($special->cuti == 'Dinas,Training')
                                <img class="ceklis10"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                    ...
                    <div class="telpn">
                        ...
                        <div class="_081329189757">{{ $special->telp }}</div>
                        <div class="line-22"></div>
                    </div>
                    <div class="batam">Batam,</div>
                    <div class="line-23"></div>
                    <div class="_29-september">
                        @if ($special->review_date)
                            {{ date('d F', strtotime($special->review_date)) }}
                        @endif
                    </div>
                    ...
                    <div class="request-sign">
                        @if ($special && $special->request_sign)
                            @php
                                $imageExtensions = ['jpg', 'jpeg', 'png'];
                                $extension = pathinfo($special->request_sign, PATHINFO_EXTENSION);
                            @endphp

                            @if (in_array($extension, $imageExtensions))
                                <img class="image" src="{{ asset('storage/images/Sign/' . $special->request_sign) }}"
                                    alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                            @endif
                        @endif
                    </div>
                    <div class="employee-name">{{ $special->user->name }}</div>
                    ...
                    <div class="approved2">
                        @if ($special && $special->approve1_sign)
                            @if ($special->approve1_sign === 'Reject')
                                <p class="reject">Reject</p>
                            @elseif($special->approve1_sign === $special->request_sign)
                                <style>
                                    .rectangle-sign-spv {
                                        background: #B6B6B6;
                                    }
                            ...
                            @else
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($special->approve1_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $special->approve1_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
                    ...
                    <div class="approved3">
                        @if ($special && $special->approve2_sign)
                            @if ($special->approve2_sign === 'Reject')
                                <p class="reject">Reject</p>
                            @elseif($special->approve2_sign === $special->request_sign)
                                <style>
                                    .rectangle-sign-hod {
                                        background: #B6B6B6;
                                    }
                            ...
                            @else
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($special->approve2_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $special->approve2_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
                    ...
                    <div class="approved4">
                        @if ($special && $special->review_sign)
                            @if ($special && $special->review_sign)
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($special->review_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $special->review_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
            ...
            <!-- Review HR -->
            @if (!$special->review_sign)
                <div class="row justify-content-center">
                    <div class="col-2">
                        <form action="{{ route('specialleave.check', $special->id) }}" method="POST"
