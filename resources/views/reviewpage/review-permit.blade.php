        ...
        <div class="card-body">
            <div class="desktop-2">
                <div class="a-4-1">
                    ...
                    @if ($permit->user->employee_id >= 200000)
                    ...
                    <div class="identitas-kiri">
                        ...
                        <div class="div">:</div>
                        <div class="fullname">{{ $permit->user->name }}</div>
                        <div class="position">Position</div>
                        <div class="div2">:</div>
                        <div class="position-name">{{ $permit->position_name }}</div>
                        <div class="superior-name">Direct Superior</div>
                        <div class="div3">:</div>
                        <div class="superior-name1">{{ $permit->superior_name }}</div>
                        <div class="department">Department</div>
                        <div class="div4">:</div>
                        <div class="department-fullname">{{ $permit->department }}</div>
                    </div>
                    <div class="identitas-kanan">
                        <div class="employee-id">Employee ID</div>
                        <div class="div9">:</div>
                        <div class="employee-id2">{{ $permit->user->employee_id }}</div>
                        <div class="position-code">Position Code</div>
                        <div class="div8">:</div>
                        <div class="position-code2">{{ $permit->position_code }}</div>
                        <div class="position-code-direct">Position Code</div>
                        <div class="div10">:</div>
                        <div class="position-code-direct2">{{ $permit->superior_code }}</div>
                    </div>
                    <div class="ketleave">
                        ...
                        <div class="unpaid-leave">
                            ...
                            <div class="d-day">:</div>
                            <div class="day">{{ $permit->jumlah_hari }}</div>
                            <div class="start-date">Start Date</div>
                            <div class="d-day2">:</div>
                            <div class="day2">{{ $permit->from_date ? date('d-m-Y', strtotime($permit->from_date)) : '' }}</div>
                            <div class="end-date">End Date</div>
                            <div class="d-day3">:</div>
                            <div class="day3">{{ $permit->to_date ? date('d-m-Y', strtotime($permit->to_date)) : '' }}</div>
                            <div class="date-back-office">Date Back Office</div>
                            <div class="d-day4">:</div>
                            <div class="day4">{{ $permit->backoffice_date ? date('d-m-Y', strtotime($permit->backoffice_date)) : '' }}</div>
                        </div>
                        <div class="datang-terlambat">
                            <div class="rectangle-34"></div>
                            @if ($permit->permit == 'Datang Terlambat')
                                <img class="ceklis2"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                            ...
                            <div class="_tik">:</div>
                            <div class="ket1">{{ $permit->ket_lambat }}</div>

                            <div class="date">Date</div>
                            <div class="_tik1">:</div>
                            <div class="date1">{{ $permit->tanggal_datang_lambat ? date('d-m-Y', strtotime($permit->tanggal_datang_lambat)) : '' }}</div>

                            <div class="time">Time</div>
                            <div class="_tik3">:</div>
                            @if ($permit->jam_datang_lambat)
                                <div class="time1">{{ date('H:i', strtotime($permit->jam_datang_lambat)) ?? '' }}</div>
                            @endif
                        </div>
                        <div class="pulang-cepat">
                            <div class="rectangle-35"></div>
                            @if ($permit->permit == 'Pulang Cepat')
                                <img class="ceklis3"
                                    src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('storage/images/Ceklis.png'))) }}" />
                            @endif
                            ...
                            <div class="_1tik">:</div>
                            <div class="ket-pulangcepat1">{{ $permit->ket_cepat }}</div>

                            <div class="date_pulangcepat">Date</div>
                            <div class="_2tik">:</div>
                            <div class="date1_pulangcepat">{{ $permit->tanggal_pulang_cepat ? date('d-m-Y', strtotime($permit->tanggal_pulang_cepat)) : '' }}</div>

                            <div class="time_pulang">Time</div>
                            <div class="_3tik">:</div>
                            @if ($permit->jam_pulang_cepat)
                                <div class="time_pulang1">{{ date('H:i', strtotime($permit->jam_pulang_cepat)) ?? '' }}
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="telpn">
                        ...
                        <div class="_081329189757">{{ $permit->telp }}</div>
                        <div class="line-22"></div>
                    </div>
                    <div class="batam">Batam,</div>
                    <div class="line-23"></div>
                    <div class="_29-september">
                        @if ($permit->review_date)
                            {{ date('d F', strtotime($permit->review_date)) }}
                        @endif
                    </div>
                    ...
                    <div class="request-sign">
                        @if ($permit && $permit->request_sign)
                            @php
                                $imageExtensions = ['jpg', 'jpeg', 'png'];
                                $extension = pathinfo($permit->request_sign, PATHINFO_EXTENSION);
                            @endphp

                            @if (in_array($extension, $imageExtensions))
                                <img class="image" src="{{ asset('storage/images/Sign/' . $permit->request_sign) }}"
                                    alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                            @endif
                        @endif
                    </div>
                    <div class="employee-name">{{ $permit->user->name }}</div>
                    ...
                    <div class="approved2">
                        @if ($permit && $permit->approve1_sign)
                            @if ($permit->approve1_sign === 'Reject')
                                <p class="reject">Reject</p>
                            @elseif($permit->approve1_sign === $permit->request_sign)
                                <style>
                                    .rectangle-sign-spv {
                                        background: #B6B6B6;
                                    }
                            ...
                            @else
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($permit->approve1_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $permit->approve1_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
                    ...
                    <div class="approved3">
                        @if ($permit && $permit->approve2_sign)
                            @if ($permit->approve2_sign === 'Reject')
                                <p class="reject">Reject</p>
                            @elseif($permit->approve2_sign === $permit->request_sign)
                                <style>
                                    .rectangle-sign-hod {
                                        background: #B6B6B6;
                                    }
                            ...
                            @else
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($permit->approve2_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $permit->approve2_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
                    ...
                    <div class="approved4">
                        @if ($permit && $permit->approve3_sign)
                            @if ($permit->approve3_sign === 'Reject')
                                <p class="reject">Reject</p>
                            @else
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($permit->approve3_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $permit->approve3_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        @endif
                    ...
                    <div class="hrofficer-sign">
                        ...
                        <div class="approve">
                            @if ($permit && $permit->review_sign)
                                @php
                                    $imageExtensions = ['jpg', 'jpeg', 'png'];
                                    $extension = pathinfo($permit->review_sign, PATHINFO_EXTENSION);
                                @endphp

                                @if (in_array($extension, $imageExtensions))
                                    <img class="image" src="{{ asset('storage/images/Sign/' . $permit->review_sign) }}"
                                        alt="Sign_image" style="width: 100px; height: auto; padding: 10px; margin: 0px; ">
                                @endif
                            @endif
                        </div>
            ...
            @if (!$permit->review_sign)
                <div class="row justify-content-center">
                    <div class="col-2">
                        <form action="{{ route('permit.check', $permit->id) }}" method="POST"
