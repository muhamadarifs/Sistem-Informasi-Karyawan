...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('review.mainindex')}}">Approval List</a></li>
                    ...
                    <div class="table-responsive  mt-2 overflow-x: auto;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">Neccesary</th>
                                <th style="text-align: center;">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($certificatemgt5  as $items)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($items->create_sign == null && $items->form_number !== null)
                                                <form action="{{ route('indexmgt5.approve', $items->id)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <button type="submit" class="btn btn-primary">Approved</button>
                                                </form>
                                            @elseif ($items->form_number == null)
                                                <button type="submit" class="btn btn-primary" disabled>Approved</button>
                                            @else
                                                <span class="success-approve">Success Approved</span>
                                            @endif
                                        </td>
                                    </tr>
                            @empty
