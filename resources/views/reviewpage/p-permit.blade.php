                                        ...
                                        <td>
                                            @if ($items->review_date == null)
                                                @if ($items->status == 'waiting')
                                                    <a href="{{ route('review.permitform', $items->id)}}" class="btn btn-primary" style="pointer-events: none; opacity: 0.6;">Review</a>
                                                @else
                                                    <a href="{{ route('review.permitform', $items->id)}}" class="btn btn-primary">Review</a>
                                                @endif 
                                            @else
                                                <a href="{{ route('review.permitform', $items->id)}}" class="btn btn-success">Details</a>
                                            @endif
                                        </td>
                                    </tr>
                            @empty
