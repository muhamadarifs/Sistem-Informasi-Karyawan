                    ...
                    <div class="table-responsive  mt-2 overflow-x: auto;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">Number Leave Day</th>
                        ...
                        <tbody>
                            @forelse ($reviewHR  as $items)
                                    <tr>
                                        ...
                                        <td>
                                            @if($items->pdf_file)
                                                <a href="{{ Storage::url('public/pdf/Cuti Special/' . str_replace(' ', '_', $items->cuti) . '/' . $items->user->nik . '-' . $items->user->name . '/' . $items->pdf_file) }}" target="_blank" class="btn btn-danger"><i class="fa-regular fa-file-pdf"></i></a>
                                            @else
                                                No PDF
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($items->review_date == null)
                                                <a href="{{ route('review.cutispecial', $items->id)}}" class="btn btn-primary">Review</a>
                                            @else
                                                <a href="{{ route('review.cutispecial', $items->id)}}" class="btn btn-success">Details</a>
                                            @endif
                                        </td>
                                    </tr>
                            @empty
