    ...
    <div class="no-margin-top">
        <div style="background: #ffffff; height: 1000px; position: relative; overflow: hidden;">
            <div style="background: #ffffff; width: 738px; height: 1002px; position: absolute; left: 0px; top: -1px; overflow: hidden;">
                <img class="fm-logo-1-2" style="width: 137px; height: 101px; position: absolute; left: 58px; top: 37px; object-fit: cover;" src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('storage/images/1.png'))) }}"/>
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 436px; top: 263px; width: 220px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 436px; top: 297px; width: 220px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 436px; top: 331px; width: 220px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 482px; top: 602px; width: 150px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 482px; top: 743px; width: 150px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 482px; top: 764px; width: 150px; align-items: center; justify-content: flex-start;">
                ...
                <div style="color: #000000; text-align: left; font-weight: 400; position: absolute; left: 488px; top: 828px; width: 144px; align-items: center; justify-content: flex-start;">
                    : IDR. {{ number_format($data->take_pay ?? 0, 0, ',', '.')  }}
                </div>
