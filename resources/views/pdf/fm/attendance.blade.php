...
<body>
    ...
    <div class="attendance-pdf">
        <img class="fm-logo-1-1" src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('storage/images/1.png'))) }}" />
        ...
        <div class="div5">:</div>
        <div class="asst-general-manager-opeational border">
