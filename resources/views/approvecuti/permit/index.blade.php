        ...
        <div class="card-body">
            ...
            @if (
                ($leave->position_code === 'ITD1' && $leave->superior_code === 'MGT2') ||
                    ...
                    ($leave->position_code === 'MGT5' && $leave->superior_code === 'MGT3'))
                <style>
                    .approval-sectionspv {
                        display: none;
                    }
            ...
            @if (!$leave->approve1_name && $leave->position_code != 'HR02')
                <div class="approval-sectionspv">
                    <div class="row justify-content-center">
                        <div class="col-3">
                            <form action="{{ route('permit.reject', $leave->id) }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-danger">Reject Supervisor</button>
                            </form>
                        </div>
                        <div class="col-3">
                            <form action="{{ route('permit.approve', $leave->id) }}" method="POST"
            ...
            @if (
                ...
                <div class="approval-section">
                    <div class="row justify-content-center">
                        <div class="col-3">
                            <form action="{{ route('permit.rejecthod', $leave->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-danger">Reject Manager</button>
                            </form>
                        </div>
                        <div class="col-3">
                            <form action="{{ route('permit.approvehod', $leave->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
