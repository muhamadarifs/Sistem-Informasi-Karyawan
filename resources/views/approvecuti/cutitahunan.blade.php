                        ...
                        <tbody>
                            ...
                            @forelse ($cutiBawahan  as $items)
                                <tr>
                                    ...
                                    <td>{{ $items->tujuan }}</td>
                                    <td>{{ $items->leave_balance }}</td>
                                    <td>{{ $items->telp }}</td>
                                    <td>{{ $items->approval1_date ? date('d-m-Y', strtotime($items->approval1_date)) : '' }}</td>
                                    <td>
                                        @if ($items->approve1_name !== null)
                                        <a href="{{ route('annualleave.details', $items->id)}}" class="btn btn-success">Check Form</a>
                                        @else
                                        <a href="{{ route('annualleave.form', $items->id)}}" class="btn btn-primary">View</a>
                                        @endif
                                    </td>
                                </tr>
                                @php
                            ...
                            @forelse ($approve2 as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('annualleave.details', $data->id)}}" class="btn btn-success">Check Form</a>
                                        @else
                                        <a href="{{ route('annualleave.form', $data->id)}}" class="btn btn-primary">View</a>
                                        @endif
                                    </td>
                                </tr>
                                @php
