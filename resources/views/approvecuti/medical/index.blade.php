        ...
        <div class="card-body">
            <div class="desktop-2">
                <div class="a-4-1">
                    ...
                    <div class="identitas-kiri">
                        ...
                        <div class="div3">:</div>
                        <div class="dept-name">{{ $leave->department }}</div>
                        ...
                        <div class="div5">:</div>
                        <div class="superior-name">{{ $leave->superior_name }}</div>
                        <div class="position-code2">Position Code</div>
                        <div class="div7">:</div>
                        <div class="superior-code">{{ $leave->superior_code }}</div>
                    </div>
            ...
            @if (!$leave->approve1_name && $leave->position_code != 'HR02')
                <div class="approval-sectionspv">
                    <div class="row justify-content-center">
                        <div class="col-2">
                            <form action="{{ route('medical.reject', $leave->id) }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-danger">Reject</button>
                            </form>
                        </div>
                        <div class="col-2">
                            <form action="{{ route('medical.approve', $leave->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <button type="submit" class="btn btn-success">Approve spv</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            @if (
                ...
                <div class="approval-section">
                    <div class="row justify-content-center">
                        <div class="col-3">
                            <form action="{{ route('medical.rejecthod', $leave->id) }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-danger">Reject Manager</button>
                            </form>
                        </div>
                        <div class="col-3">
                            <form action="{{ route('medical.approvehod', $leave->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
